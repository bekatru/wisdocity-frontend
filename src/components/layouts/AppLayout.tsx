...
const learnerNavigation = [
  ...
  {
    name: "Dashboard",
    href: Routes.LearnerDashboard,
    icon: Squares2X2Icon,
    current: false,
  },
  {
    name: "Chats",
    href: Routes.LearnerChats,
    icon: ChatBubbleLeftIcon,
    current: false,
  },
  {
    name: "Community",
    href: Routes.LearnerCommunity,
    icon: UsersIcon,
    current: false,
  },
  {
    name: "Profile",
    href: Routes.LearnerProfile,
    icon: UserIcon,
    current: false,
  },
  {
    name: "Help",
    href: Routes.LearnerHelp,
...
const expertNavigation = [
  ...
  {
    name: "Avatar",
    href: Routes.ExpertAvatar,
    icon: UserCircleIcon,
    current: false,
  },
  {
    name: "Wisdom",
    href: Routes.ExpertWisdom,
    icon: BookOpenIcon,
    current: false,
  },
  {
    name: "Profile",
    href: Routes.ExpertProfile,
    icon: UserIcon,
    current: false,
  },
  {
    name: "Help",
    href: Routes.ExpertHelp,
    icon: QuestionMarkCircleIcon,
    current: false,
  },
];
...
export function AppLayout(props: PropsWithChildren) {
  ...
  const navigation = useMemo(() => {
    switch (auth.data?.current_role) {
      case "learner":
        return learnerNavigation.map((navigation) => ({
          ...navigation,
          current: isCurrentRoute(navigation.href),
        }));
      case "expert":
        return expertNavigation.map((navigation) => ({
          ...navigation,
          current: isCurrentRoute(navigation.href),
        }));
      default:
    ...
    <>
      <div className="min-h-screen">
                    ...
                    <nav className="flex flex-1 flex-col">
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        ...
                        <li className="mt-auto">
                          <a className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-purple-200 hover:bg-purple-700 hover:text-white">
                            <Cog6ToothIcon
        ...
        <div className="lg:pl-60 min-h-screen flex flex-col">
          ...
          <main className="p-6 flex-grow flex">{props.children}</main>
        </div>
      </div>
    </>
  );
