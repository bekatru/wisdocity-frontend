...
import { Popselect, Checkbox, MultiSelect, MultiSelectOption } from 'components';
            ...
            <div className='max-w-[55%]'>
                <div className="sm:flex sm:items-center">
                    <div className="relative flex border h-9 w-[300px] p-2 rounded-md mr-4 items-center">
                        <MagnifyingGlassIcon className="pointer-events-none absolute inset-y-0 left-2 h-full w-5 text-gray-400" aria-hidden="true" />
                        <input
                            id="search-field"
                            ...
                            <table className="min-w-full divide-y divide-gray-300">
                                ...
                                <tbody className="divide-y divide-gray-200 bg-white">
                                    <tr className="bg-white">
                                        ...
                                        <td className="whitespace-nowrap py-3 pl-4 pr-3 text-sm">Interviews</td>
                                        <td className="whitespace-nowrap px-3 py-3 text-sm text-gray-500">
                                            <button type="button" className="text-[#321841] bg-[#F1E8F8] fn fw-r fw-r rounded-full px-4 py-1 text-center text-[14px] mr-[15px] ">Career</button>
                                            <button type="button" className="text-[#321841] bg-[#F1E8F8] fn fw-r fw-r rounded-full px-4 py-1 text-center text-[14px] mr-[15px] ">Career</button>
                                        </td>
                                        ...
                                        <td>
                                            <Popselect
                                                ...
                                                options={[
                                                    {
                                                        icon: <EyeIcon className='text-[#321841] w-5 h-5 mt-[3px]' />,
                ...
                <nav className="flex items-center justify-center border-t border-gray-200 px-4 sm:px-0 mt-4 gap-6 pb-5">
                    ...
                    <div className="hidden md:-mt-px md:flex">
                        <a className="inline-flex items-center border-t-2 px-4 pt-4 text-sm font-medium cursor-pointer border-purple-500 text-purple-600">1</a>
                    </div>
                    <div className="-mt-px flex">
