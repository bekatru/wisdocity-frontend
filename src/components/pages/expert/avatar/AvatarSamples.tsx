    ...
    return (
        <>
            <div className="box-body  mb-[10px]">
                <h4 className="fn fw-b text-[16px] text-[#321841] mb-[24px]">Avatar samples</h4>
                <div className="flex flex-wrap  -mx-4 md:max-w-[100%]">

                    <div className="w-full md:w-1/4 xs:w-1/1 mb-[34px] px-4">
                        <div className="card bg-white px-6 py-6 border-[#D9D9EB] border-[1px] rounded-[12px]">
                            <div className="flex justify-between items-center w-full">
                                <h4 className="fn fw-sb text-[18px] text-[#321841] mt-[1px]">My sample of voice</h4>
                    ...
                    <div className="w-full md:w-1/4 xs:w-1/1 mb-[34px] px-4">
                        <div className="card bg-white px-6 py-6 border-[#D9D9EB] border-[1px] rounded-[12px]">
                            <div className="flex justify-between items-center w-full">
                                <h4 className="fn fw-sb text-[18px] text-[#321841] mt-[1px]">Video Sample</h4>
                                <div className="flex items-center">
                                    <MyDropdown />
                                </div>
                            </div>
            ...
            <div className="box-body  mb-[32px]">
                <h4 className="fn fw-b text-[16px] text-[#321841] mb-[24px]">Channels</h4>
