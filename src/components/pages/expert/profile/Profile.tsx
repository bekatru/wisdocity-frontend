...
export function Profile() {
    // Sample rating value, replace with your actual rating value
    const ratingValue = 4.8;

    // State variable to manage the open/close state of each accordion
                                ...
                                <div className="pl-[24px]">
                                    ...
                                    <div className="flex items-center">
                                        <StarRating
                                            ...
                                            edit={false}
                                        />
                                        <span className="ms-[8px] text-[14px] fn fw-m text-[#6B6985]">{ratingValue} (20 reviews)</span>
                                    </div>
                                </div>
                                ...
                                <div className="w-full">
                                    ...
                                    <form>
                                        <div className="relative">
                                            <input type="search" id="search" className="h-12 w-[85%] border border-gray-300 rounded-lg bg-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Interviews" required />
                                            <button type="submit" className="text-white bg-btn-theme fn fw-sb rounded-full px-8 py-3 text-center text-[16px] ml-[10px]">Save</button>
                                        </div>
                                    </form>
