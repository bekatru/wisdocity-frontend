...
import { useProfile ,useExpertProfile} from 'modules/auth';
        ...
        <>
            <div className="flex flex-wrap">
                <div className="w-full md:w-1/3 xs:w-1/1 md:mr-[35px] mb-[34px]">
                    ...
                    {expert_profile.data &&  <ProfileInformation username={expert_profile.data.username} profession={expert_profile.data.profession}/>}
