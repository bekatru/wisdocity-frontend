                                ...
                                <div className="box-body w-full">
                                    <div className="flex align-center w-full">
                                        <div className="w-full">
                                            <div className="text-center text-[20px] fn fw-b text-[#321841] mb-[24px]">Edit Bio
                                            </div>
                                            <form>
                                                <div className="mb-[24px]">
                                                    <Label className='flex text-[16px] fn fw-sb text-[#321841] mb-[6px]'>Bio</Label>
                                                    <Input type="text" placeholder="" value={bio} onChange={(e) => setBio(e.target.value)}/>
                                                </div>
