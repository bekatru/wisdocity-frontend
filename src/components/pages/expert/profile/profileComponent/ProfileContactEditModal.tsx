...
interface ProfileContactEditModalProps {
    ...
    address:string;
    expertId:number;
    onProfileUpdate: (newContactNumber: string, newEmail:string,newAddress:string) => void;

}
export function ProfileContactEditModal(props: ProfileContactEditModalProps) {
    const [isOpen, setIsOpen] = useState(false);
    const [contactNumber, setContactNumber] = useState<string>(props.contactNumber);
                                ...
                                <div className="box-body w-full">
                                    <div className="flex align-center w-full">
                                        <div className="w-full">
                                            <div className="text-center text-[20px] fn fw-b text-[#321841] mb-[24px]">Edit Contact
                                            </div>
                                            <form>
                                                <div className="mb-[24px]">
                                                    <Label className='flex text-[16px] fn fw-sb text-[#321841] mb-[6px]'>Contact Number</Label>
                                                    <Input type="text" placeholder="" value={contactNumber} onChange={(e) => setContactNumber(e.target.value)}/>
                                                </div>
                                                <div className="mb-[24px]">
                                                    <Label className='flex text-[16px] fn fw-sb text-[#321841] mb-[6px]'>Email</Label>
                                                    <Input type="email" placeholder="" value={email} onChange={(e) => setEmail(e.target.value)}/>
                                                </div>
                                                <div className="mb-[24px]">
                                                    <Label className='flex text-[16px] fn fw-sb text-[#321841] mb-[6px]'>Address</Label>
