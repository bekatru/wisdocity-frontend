...
export function ProfileInformationEditModal(props: ProfileInformationEditModalProps) {
    ...
    const {mutate: editProfileInformation, isPending} = useEditProfileInformation({
        onSuccess: () => {
                                ...
                                <div className="box-body w-full">
                                    <div className="flex align-center w-full">
                                        <div className="w-full">
                                            <div className="text-center text-[20px] fn fw-b text-[#321841] mb-[24px]">Edit Information
                                            </div>
                                            <form>
                                                <div className="mb-[24px]">
                                                    <Label className='flex text-[16px] fn fw-sb text-[#321841] mb-[6px]'>Name</Label>
                                                    <Input type="text" placeholder="John" value={name} onChange={(e) => setName(e.target.value)}/>
                                                </div>
                                                <div className="mb-[24px]">
                                                    <Label className='flex text-[16px] fn fw-sb text-[#321841] mb-[6px]'>Profession</Label>
                                                    <Input type="text" placeholder="Expert" value={profession} onChange={(e) => setProfession(e.target.value)}/>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
