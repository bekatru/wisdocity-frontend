...
export function HomeAvatars() {
    return (
        <div className="bg-none py-24 sm:py-32 pb-0  mb-[160px]">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">

                <div className="mx-auto w-full lg:mx-0 text-center">
                    <h2 className="text-white ft leading-normal	 text-[64px] mb-[5px] text-[#321841]">Enhanced Learning via Avatars</h2>
                    <p className="fn  fw-r text-white text-[18px] mb-[80px] text-[#321841]">
                ...
                <div className="flex flex-wrap -mx-4 avatar_cards">
                    ...
                    <div className="w-full md:w-1/2 px-4  mb-[20px]">
                        <div className="w-full p-6 bg-white rounded-lg shadow-d dark:bg-gray-800 text-left h-full min-h-52">
